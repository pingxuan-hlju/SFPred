...
class FCTransformer(nn.Module):
    def __init__(self):
        super().__init__()
        self.layer1 = cnn_att(in_planes=2,out_planes=64,in_feat=1134,out_feat=256)  #卷积+att一次结果
        self.layer2 = cnn_att(in_planes=64,out_planes=16,in_feat=256,out_feat=64)
        self.mlp =MLP()
